 ...
 * Tue Apr 16 2024 18:20:22 GMT+0530 (India Standard Time)
...
setHTMLElemStyle('height', '60px', 'white', false);
setHTMLElemStyle('width', '60px', 'white', false);
setHTMLElemStyle('display', 'block', 'white', false);
setHTMLElemStyle('marginLeft', '0 auto', 'white', false);
setHTMLElemStyle('alignSelf', 'flex-start', 'white', false);
setHTMLElemAttribute('innerHTML', 'white', 'white', false);
eventHTMLElem('click', 'white', false, function(event) {
  setObjTransform(cloneObject('Block.001'), false, 'position', [7, -1, i], false);
  changeVis('Block.001', true);
  i = (typeof i == 'number' ? i : 0) + 6;
  registerOnDrag('Block.001', false, [0,1,2], function() {}, function() {
    dragMove('Block.001', 'XYZ', ':6rdJ~Cpo|cSf`:VGj+p', 's^,_7WeG%~K5?LV(wAwi');
    dragRotate('Block.001', 'X', true, '-J?OIeI3[I%fx2U1*VuC', 's^,_7WeG%~K5?LV(wAwi');
  }, function() {}, 's^,_7WeG%~K5?LV(wAwi');
});
...
setHTMLElemStyle('marginLeft', '0 auto', 'blue', false);
setHTMLElemStyle('alignSelf', 'flex-start', 'blue', false);
setHTMLElemAttribute('innerHTML', 'blue', 'blue', false);
eventHTMLElem('click', 'blue', false, function(event) {
  setObjTransform(cloneObject('Block2'), false, 'position', [7, -1, i], false);
  changeVis('Block2', true);
  i = (typeof i == 'number' ? i : 0) + 6;
  registerOnDrag('Block2', false, [0,1,2], function() {}, function() {
    dragMove('Block2', 'XYZ', '`EV]_bnNc]wFQTE4vJVe', 'zSO?7csyiO5,UCDj(12a');
    dragRotate('Block2', 'X', true, '|3U%_r(,yxugl7Mk5/Qe', 'zSO?7csyiO5,UCDj(12a');
  }, function() {}, 'zSO?7csyiO5,UCDj(12a');
});
